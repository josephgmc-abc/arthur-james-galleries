      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-navy max-w-none font-sans text-charcoal/80 leading-relaxed space-y-12">
          ...
          <section>
            ...
            <p>
              Under the General Data Protection Regulation (GDPR), you have the right to access, rectify, or erase your personal data held by us. To exercise these rights, please contact our data protection liaison at london@arthurjames.com.
            </p>
          </section>
